...
idCVar si_map(						"si_map",					"game/mp/test1",CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE, "map to be played next on server", idCmdSystem::ArgCompletion_MapName );
...
idCVar g_gravity(					"g_gravity",		"355", CVAR_GAME | CVAR_FLOAT, "" );
